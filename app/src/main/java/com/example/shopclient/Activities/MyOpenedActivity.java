...
public class MyOpenedActivity extends AppCompatActivity {
    ...
    final LoadingDialog loadingDialog= new LoadingDialog(MyOpenedActivity.this);
    final ServerDialog serverDialog= new ServerDialog(MyOpenedActivity.this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE); //will hide the title
        getSupportActionBar().hide(); // hide the title bar
        setContentView(R.layout.activity_my_opened);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                MyOpenedActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    public void removeItemClick(View view) {
        String url2 = ip+"api/items/"+selectedItem.id;
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if(response.isSuccessful()){
                    MyOpenedActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            setToastMessage("Item succesfully Deleted");
                            onBackPressed();
                        }
                    });
                }else{
    ...
    public void onBackPressed() {
        ...
        Intent myintent = new Intent(getApplicationContext(), MyItemsActivity.class);
        myintent.putExtra("login_email",login_email);
